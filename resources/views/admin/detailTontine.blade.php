            ...
            <div class="row">
               <div class="col-lg-8">
                  ...
                  <div class="card cardnavbar mb-3">
                     <div class="card-body">
                        <h4 class="fw-bold">DÉTAILS TONTINE FAMILIALE</h4>
                        <div class="text-dark">EN COURS - 500 000 FCFA - 12 participants</div>
                     </div>
                  </div>
                     ...
                     <div class="user-tabing">
                        <ul class="nav nav-pills d-flex align-items-center justify-content-center profile-feed-items p-0 m-0 round">
                           <li class="nav-item col-12 col-sm-3 p-0">
                              <a class="nav-link active" href="#pills-tous-tab" data-bs-toggle="pill" data-bs-target="#pills-tous-tab" role="button">Tous</a>
                           </li>
                           <li class="nav-item col-12 col-sm-3 p-0">
                              <a class="nav-link" href="#pills-paye-tab" data-bs-toggle="pill" data-bs-target="#pills-paye-tab" role="button">Payé</a>
                           </li>
                           <li class="nav-item col-12 col-sm-3 p-0">
                              <a class="nav-link" href="#pills-retard-tab" data-bs-toggle="pill" data-bs-target="#pills-retard-tab" role="button">En retard</a>
                           </li>
                        </ul>
                     </div>
                  </div>
                  ...
                  <div class="tab-content forum-content">
                     <div class="tab-pane fade show active" id="pills-tous-tab">
                        <div class="row">
                           <!-- Participant 1 -->
                              ...
                              <div class="card">
                                 <div class="card-body">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div style="width: 40px; height: 40px; background-color: #4a89dc; color: white; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin-right: 15px;">
                                          AD
                                       </div>
                                       
                                       <div class="flex-grow-1">
                                          <h5 class="mb-1">Ahmed Diallo</h5>
                                          <div class="d-flex align-items-center">
                                             ...
                                             <span class="badge bg-info">Prochain tour</span>
                                          </div>
                                          <div class="mt-2">Cotisé: 75 000 FCFA</div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="col-sm-12 mt-3">
                              <div class="card">
                                 <div class="card-body">
                                    <div class="d-flex align-items-center">
                                       <!-- Avatar avec initiales -->
                                       <div style="width: 40px; height: 40px; background-color: #f5b755; color: white; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin-right: 15px;">
                                          MT
                                       </div>
                                       
                                       <div class="flex-grow-1">
                                          <h5 class="mb-1">Marie Touré</h5>
                                          <div class="d-flex align-items-center">
                                             ...
                                             <span class="badge bg-secondary">Tour passé</span>
                                          </div>
                                          <div class="mt-2">Cotisé: 50 000 FCFA</div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="col-sm-12 mt-3">
                              <div class="card">
                                 <div class="card-body">
                                    <div class="d-flex align-items-center">
                                       <!-- Avatar avec initiales -->
                                       <div style="width: 40px; height: 40px; background-color: #a989e0; color: white; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin-right: 15px;">
                                          JK
                                       </div>
                                       
                                       <div class="flex-grow-1">
                                          <h5 class="mb-1">Jean Konaté</h5>
                                          <div class="d-flex align-items-center">
                                             <span class="badge bg-success me-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                                   <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
                                             ...
                                             <span class="badge" style="background-color: #a989e0;">Tour: 6</span>
                                          </div>
                                          <div class="mt-2">Cotisé: 75 000 FCFA</div>
                                       </div>
                                    </div>
                           ...
                           <div class="col-sm-12 mt-3 text-center">
                              <div class="d-inline-block mx-1 bg-secondary rounded-circle" style="width: 8px; height: 8px;"></div>
                              <div class="d-inline-block mx-1 bg-secondary rounded-circle" style="width: 8px; height: 8px;"></div>
                              <div class="d-inline-block mx-1 bg-secondary rounded-circle" style="width: 8px; height: 8px;"></div>
                           </div>
                        </div>
                     ...
                     <!-- Les autres onglets (contenu similaire mais filtré) -->
                     <div class="tab-pane fade" id="pills-paye-tab">
                        <!-- Contenu similaire mais filtré pour les payés -->
                     </div>
                     
                     <div class="tab-pane fade" id="pills-retard-tab">
                        <!-- Contenu similaire mais filtré pour les retards -->
                        <div class="col-sm-12 mt-3">
                           <div class="card">
                              <div class="card-body">
                                 <div class="d-flex align-items-center">
